...
- ✅ **v1.1 Multi-Provider & Asana Integration** — Phases 14-17 shipped 2026-04-09
...
- [x] **Phase 17: Asana Integration** — `AsanaService`, `AsanaTaskSource`, config mapping, and PR link comment-back (completed 2026-04-08)
...
**Plans**: 3 plans
Plans:
- [x] 15-01-PLAN.md — Install openai-php/client, LlmResponseNormalizer, ToolSchemaTranslator, config getters, stopReason normalization
- [x] 15-02-PLAN.md — OpenAiCompatClient, LlmClientFactory, AppServiceProvider wiring
- [x] 15-03-PLAN.md — RunCommand factory wiring, Ollama probe, model capability warning
...
| 15. Provider Implementations | 3/3 | Complete    | 2026-04-08 |
...
- Milestone v1.1 shipped 2026-04-09 — all 4 phases, 12 plans complete
